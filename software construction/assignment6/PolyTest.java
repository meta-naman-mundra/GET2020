...
public class PolyTest {
	...
	public void test_Add_Polyinomial() throws Exception {
		int returnedArrOperation[] = Poly.addPoly(new Poly(new int[] { 1, 0, 2,
				0, 4 }), new Poly(new int[] { 0, 1, 0, 5 }));
	...
	public void test_Multiply_Polyinomial() throws Exception {
		int returnedArrOperation[] = Poly.mulPoly(new Poly(new int[] { 1, 0, 2,
				0, 4 }), new Poly(new int[] { 0, 1, 0, 5 }));
		int[] expectedArr = new int[] { 0, 1, 0, 7, 0, 14, 0, 20 };
		Assert.assertArrayEquals(expectedArr, returnedArrOperation);
	}
}